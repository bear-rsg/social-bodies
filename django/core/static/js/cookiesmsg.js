...
if (getCookie('cookieMessageApprove') !== '1') {
    ...
    var html_to_inject = '\
<div id="cookie-message-popup" role="contentinfo" style="text-align: center; z-index: 10000; background: black; width: 96vw; padding: 1em; color: white; position: fixed; bottom: 2vw; right: 2vw;">\
