...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='researchdata.slletterestimatedproportionofletter'),
        ),
        migrations.AddField(
            model_name='letter',
            name='letter_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_other', models.CharField(blank=True, max_length=255, null=True, verbose_name='Person/People (if not specified in Person table)')),
                ('admin_notes', models.TextField(blank=True, null=True)),
                ('admin_published', models.BooleanField(default=True)),
                ('created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('lastupdated_datetime', models.DateTimeField(auto_now=True, verbose_name='Last Updated')),
                ...
                ('letter', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='researchdata.letter')),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='researchdata.person')),
